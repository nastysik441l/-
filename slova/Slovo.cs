...
namespace ConsoleApp2
{
    ...
    public class Dict
    {
        ...
        public Dict(Language from, Language to)
        {
            ...
            {
                if (from == to)
                    throw new Exception("Язык перевода должен быть отличный !");
            }
            catch (Exception e)
            {
        ...
        private Language CheckWordLanguage(string word)
        {
            ...
            {
                Console.WriteLine("В слове нераспознан  символ или язык !");
                Console.ReadKey();
                return Language.Unknown;
            }
            ...
            for (int i = 1; i < word.Length; i++)
            {
                ...
                if (current != tmp)
                {
                    Console.WriteLine("В слове  недопустимый символ или язык !");
                    Console.ReadKey();
                    return Language.Unknown;
                }
            }
        ...
        public void Add(string word, string translation)
        {
            ...
            try
            {
                ...
                {
                    isCorrectToAdd = false;
                    throw new Exception("Несоответствие языка слова и его перевода!");
                }
        ...
        public void ChangeWord(string oldWord, string newWord)
        {
            ...
            if (values == null)
            {
                Console.WriteLine("Слово или перевод данного слова не найдено!");
                Console.ReadKey();
                return;
            }
        ...
        public void DeleteTranslation(string word, string delTranslation)
        {
            ...
            {
                Console.WriteLine("Невозможно удалить последний вариант перевода или переводов!");
                Console.ReadKey();
                return;
            }
            if (values.Contains(delTranslation.ToLower()))
            {
                Console.WriteLine("Данного  перевода не существует!");
                Console.ReadKey();
                return;
            }
        ...
        public void SearchTranslations(string word)
        {
            ...
            if (values == null)
            {
                Console.WriteLine("Не найдено переводов  слова!");
                Console.ReadKey();
                return;
            }
